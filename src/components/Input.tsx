...
{ id: string, name: string, label: string, type: string, placeholder: string }
  ...
  return (
    <fieldset>
      ...
      <input className='border text-sm rounded-lg block w-full p-2.5 bg-white/5 border-gray-600 placeholder-gray-400 text-white' type={type} name={name} id={id} placeholder={placeholder} {...props} />
    </fieldset>
  )
}
